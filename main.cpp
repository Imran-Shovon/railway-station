...
char ch;
int tr=1600,td=800,yu=50,rs=40;
...
void draw_poly(Pos a,Pos b, Pos c ,Pos d,Col co){
// Windows

glColor3f(co.red,co.green,co.blue);
glBegin(GL_POLYGON);
glVertex2f(a.posx,a.posy);
glVertex2f(b.posx,b.posy);
glVertex2f(c.posx,c.posy);
glVertex2f(d.posx,d.posy);
glEnd();
}
...
glBegin(GL_POLYGON);
glVertex2f(0,0+rs);//a
glVertex2f(1600,0+rs);//b
glVertex2f(1600,15+rs);//c
glVertex2f(0,15+rs);//d
glEnd();
...
for(l=0;l<=15;l++)
	{
		glColor3f(0.1,1.0,.9);
		draw_circle(650,280,l);
	}
draw_poly({640,238},{650,238},{650,200},{640,200},{0.1,0.2,0.8});//pant
draw_poly({651,238},{661,238},{661,200},{651,200},{0.1,0.2,0.8});//pant
draw_poly({636,268},{664,268},{670,230},{630,230},{0.8,0.8,0.6});//hands
draw_poly({632,300},{667,300},{667,288},{632,288},{0.0,0.0,0.0});//hat
draw_poly({637,310},{662,310},{662,298},{637,298},{0.0,0.0,0.0});//hat top
draw_poly({635,268},{665,268},{660,230},{640,230},{0.1,0.2,0.4});//body
draw_poly({645,275},{655,275},{653,270},{647,270},{0.0,0.0,0.0});//mouth

//eyes
glPointSize(5);
glBegin(GL_POINTS);
glColor3f(0.0,0.4,0.25);
glVertex2f(643,282);
glEnd();
glPointSize(5);
glBegin(GL_POINTS);
...
//shoes
draw_poly({651,200},{660,200},{675,188},{651,190},{0.0,0.0,0.0});
draw_poly({640,200},{650,200},{650,190},{625,188},{0.0,0.0,0.0});
int se=30;
//hand
draw_poly({632,230},{638,230},{638,225},{632,225},{0.0,0.9,0.5});
draw_poly({632+se,230},{638+se,230},{638+se,225},{632+se,225},{0.0,0.9,0.5});
...
glColor3f(0.60,0.435294,0.258824);
glBegin(GL_POLYGON);
glVertex2f(-600-i+xm+tr,50+yu);
glVertex2f(-600-i+xm+tr,300+yu);
glVertex2f(-1000-i+xm+tr,300+yu);
glVertex2f(-1000-i+xm+tr,50+yu);
glEnd();

//top

glColor3f(0.309804,0.3,0.5);
glBegin(GL_POLYGON);
glVertex2f(-590-i+xm+tr,300+yu);
glVertex2f(-590-i+xm+tr,310+yu);
glVertex2f(-1010-i+xm+tr,310+yu);
glVertex2f(-1010-i+xm+tr,300+yu);
glEnd();
...
glColor3f(1.0,1.0,1.0);
glBegin(GL_POLYGON);
glVertex2f(-825-i+xm+tr,175+yu);
glVertex2f(-825-i+xm+tr,285+yu);
glVertex2f(-985-i+xm+tr,285+yu);
glVertex2f(-985-i+xm+tr,175+yu);
glEnd();

glBegin(GL_POLYGON);
glVertex2f(-615-i+xm+tr,175+yu);
glVertex2f(-615-i+xm+tr,285+yu);
glVertex2f(-775-i+xm+tr,285+yu);
glVertex2f(-775-i+xm+tr,175+yu);
glEnd();
...
for(l=0;l<50;l++)
   {
	glColor3f(0.8,0.6,0.14);
	draw_circle(-675-i+xm+tr,50+yu,l);
	draw_circle(-925-i+xm+tr,50+yu,l);
   }
...
glColor3f(0.60,0.435294,0.258824);
glBegin(GL_POLYGON);
glVertex2f(-150-i+xm+tr,50+yu);
glVertex2f(-150-i+xm+tr,300+yu);
glVertex2f(-550-i+xm+tr,300+yu);
glVertex2f(-550-i+xm+tr,50+yu);
glEnd();
...
glColor3f(0.309804,0.3,0.5);
glBegin(GL_POLYGON);
glVertex2f(-140-i+xm+tr,300+yu);
glVertex2f(-140-i+xm+tr,310+yu);
glVertex2f(-560-i+xm+tr,310+yu);
glVertex2f(-560-i+xm+tr,300+yu);
glEnd();
...
glColor3f(1.0,1.0,1.0);
glBegin(GL_POLYGON);
glVertex2f(-375-i+xm+tr,175+yu);
glVertex2f(-375-i+xm+tr,285+yu);
glVertex2f(-535-i+xm+tr,285+yu);
glVertex2f(-535-i+xm+tr,175+yu);
glEnd();

glBegin(GL_POLYGON);
glVertex2f(-165-i+xm+tr,175+yu);
glVertex2f(-165-i+xm+tr,285+yu);
glVertex2f(-325-i+xm+tr,285+yu);
glVertex2f(-325-i+xm+tr,175+yu);
glEnd();
...
glColor3f(1.0,.0,1.0);
glBegin(GL_POLYGON);
glVertex2f(-550-i+xm+tr,75+yu);
glVertex2f(-550-i+xm+tr,95+yu);
glVertex2f(-600-i+xm+tr,95+yu);
glVertex2f(-600-i+xm+tr,75+yu);
glEnd();
...
for(l=0;l<50;l++)
   {
	glColor3f(0.8,0.6,0.14);
	draw_circle(-225-i+xm+tr,50+yu,l);
	draw_circle(-475-i+xm+tr,50+yu,l);
   }
...
glColor3f(0.60,0.435294,0.258824);
glBegin(GL_POLYGON);
glVertex2f(300-i+xm+tr,50+yu);
glVertex2f(300-i+xm+tr,300+yu);
glVertex2f(-100-i+xm+tr,300+yu);
glVertex2f(-100-i+xm+tr,50+yu);
glEnd();
...
glColor3f(0.309804,0.3,0.5);
glBegin(GL_POLYGON);
glVertex2f(310-i+xm+tr,300+yu);
glVertex2f(310-i+xm+tr,310+yu);
glVertex2f(-110-i+xm+tr,310+yu);
glVertex2f(-110-i+xm+tr,300+yu);
glEnd();
...
glColor3f(1.0,1.0,1.0);
glBegin(GL_POLYGON);
glVertex2f(75-i+xm+tr,175+yu);
glVertex2f(75-i+xm+tr,285+yu);
glVertex2f(-85-i+xm+tr,285+yu);
glVertex2f(-85-i+xm+tr,175+yu);
glEnd();

glBegin(GL_POLYGON);
glVertex2f(285-i+xm+tr,175+yu);
glVertex2f(285-i+xm+tr,285+yu);
glVertex2f(125-i+xm+tr,285+yu);
glVertex2f(125-i+xm+tr,175+yu);
glEnd();
...
glColor3f(1.0,.0,1.0);
glBegin(GL_POLYGON);
glVertex2f(-100-i+xm+tr,75+yu);
glVertex2f(-100-i+xm+tr,95+yu);
glVertex2f(-150-i+xm+tr,95+yu);
glVertex2f(-150-i+xm+tr,75+yu);
glEnd();
...
for(l=0;l<50;l++)
   {
	glColor3f(0.8,0.6,0.14);
	draw_circle(-25-i+xm+tr,50+yu,l);
	draw_circle(225-i+xm+tr,50+yu,l);
   }
...
glBegin(GL_POLYGON);
glVertex2f(-250-i+xm+td,50+yu);
glVertex2f(-250-i+xm+td,125+yu);
glVertex2f(-655-i+xm+td,125+yu);
glVertex2f(-720-i+xm+td,50+yu);
glEnd();
...
glBegin(GL_POLYGON);
glVertex2f(-260-i+xm+td,125+yu);
glVertex2f(-260-i+xm+td,325+yu);
glVertex2f(-460-i+xm+td,325+yu);
glVertex2f(-460-i+xm+td,125+yu);
glEnd();
...
glColor3f(1.0,1.0,1.0);
glBegin(GL_POLYGON);
glVertex2f(-275-i+xm+td,175+yu);
glVertex2f(-275-i+xm+td,315+yu);
glVertex2f(-445-i+xm+td,315+yu);
glVertex2f(-445-i+xm+td,175+yu);
glEnd();

//train top

glColor3f(0.309804,0.5,0.9);
glBegin(GL_POLYGON);
glVertex2f(-250-i+xm+td,325+yu);
glVertex2f(-250-i+xm+td,350+yu);
glVertex2f(-470-i+xm+td,350+yu);
glVertex2f(-470-i+xm+td,325+yu);
glEnd();
...
glBegin(GL_POLYGON);
glVertex2f(-460-i+xm+td,125+yu);
glVertex2f(-460-i+xm+td,225+yu);
glVertex2f(-655-i+xm+td,225+yu);
glVertex2f(-655-i+xm+td,125+yu);
glEnd();

glColor3f(0.0,0.0,0.0);
glBegin(GL_POLYGON);
glVertex2f(-480-i+xm+td,125+yu);
glVertex2f(-480-i+xm+td,225+yu);
glVertex2f(-490-i+xm+td,225+yu);
glVertex2f(-490-i+xm+td,125+yu);
glEnd();

glColor3f(0.0,0.0,0.0);
glBegin(GL_POLYGON);
glVertex2f(-500-i+xm+td,125+yu);
glVertex2f(-500-i+xm+td,225+yu);
glVertex2f(-510-i+xm+td,225+yu);
glVertex2f(-510-i+xm+td,125+yu);
glEnd();

glColor3f(0.0,0.0,0.0);
glBegin(GL_POLYGON);
glVertex2f(-635-i+xm+td,125+yu);
glVertex2f(-635-i+xm+td,225+yu);
glVertex2f(-645-i+xm+td,225+yu);
glVertex2f(-645-i+xm+td,125+yu);
glEnd();
...
glBegin(GL_POLYGON);
glVertex2f(-550-i+xm+td,225+yu);
glVertex2f(-550-i+xm+td,275+yu);
glVertex2f(-600-i+xm+td,275+yu);
glVertex2f(-600-i+xm+td,225+yu);
glEnd();

glColor3f(0.309804,0.3,0.5);
glBegin(GL_POLYGON);
glVertex2f(-540-i+xm+td,275+yu);
glVertex2f(-540-i+xm+td,300+yu);
glVertex2f(-610-i+xm+td,300+yu);
glVertex2f(-610-i+xm+td,275+yu);
glEnd();
...
glBegin(GL_POLYGON);
glVertex2f(-655-i+xm+td,225+yu);
glVertex2f(-665-i+xm+td,225+yu);
glVertex2f(-665-i+xm+td,185+yu);
glVertex2f(-655-i+xm+td,185+yu);
glEnd();

glColor3f(0.0,0.0,0.0);
glBegin(GL_POLYGON);
glVertex2f(-655-i+xm+td,225+yu);
glVertex2f(-685-i+xm+td,225+yu);
glVertex2f(-655-i+xm+td,205+yu);
...
glBegin(GL_POLYGON);
glVertex2f(-250-i+xm+td,75+yu);
glVertex2f(-250-i+xm+td,95+yu);
glVertex2f(-200-i+xm+td,95+yu);
glVertex2f(-200-i+xm+td,75+yu);
glEnd();
...
for(l=0;l<50;l++)
   {
	glColor3f(0.8,0.6,0.14);
	draw_circle(-325-i+xm+td,50+yu,l);
	draw_circle(-600-i+xm+td,50+yu,l);
   }
}
